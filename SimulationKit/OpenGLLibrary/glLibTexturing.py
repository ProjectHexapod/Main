...
def glLibTexture(surface, filters=[], size="automatic"):
    ...
    if "mipmap" in filters:
        if "mipmap blend" in filters:
            if "filter" in filters:
                mipmap_param = GL_LINEAR_MIPMAP_LINEAR
            else:
                mipmap_param = GL_NEAREST_MIPMAP_LINEAR
        else:
            if "filter" in filters:
                mipmap_param = GL_LINEAR_MIPMAP_NEAREST
            else:
                mipmap_param = GL_NEAREST_MIPMAP_NEAREST
