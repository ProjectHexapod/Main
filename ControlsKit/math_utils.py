...
def inTriangle(P, A, B, C, g=None):
    # avoid putting mutable object as default arg
    if g is None:
        g = [0, 0, -1]
    ...
    u = (dr1 - d12 / (d22 - d23 * d23 / d33) * (dr2 - dr3 * d23 / d33) - d13 / d33 *
         (dr3 - d23 / (d22 - d23 * d23 / d33) * (dr2 - dr3 * d23 / d33))) / \
        (d11 + d12 / (d22 - d23 * d23 / d33) * (d13 * d23 / d33 - d12) - d13 / d33 *
         (d13 + d23 / (d22 - d23 * d23 / d33) * (d13 * d23 / d33 - d12)))
