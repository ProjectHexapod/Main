...
export LoadConfig_MagneticEncoder
export _LoadConfig_MagneticEncoder
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_MagneticEncoder
...
;---------------------------------------------------------------------------
; Load Configuration MagneticEncoder
;
;    Load configuration registers for MagneticEncoder.
...
;               CUR_PP
;
_LoadConfig_MagneticEncoder:
 LoadConfig_MagneticEncoder:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_MagneticEncoder            ; Call load config table routine
