...
export LoadConfigTBL_serialtest1_Bank1
export LoadConfigTBL_serialtest1_Bank0
export LoadConfigTBL_serialtest1_Ordered
AREA lit(rom, rel)
LoadConfigTBL_serialtest1_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_serialtest1_Bank1:
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
	db		2ch, 05h		;UART_RX_FUNC_REG   (DCB03FN)
	db		2dh, c5h		;UART_RX_INPUT_REG  (DCB03IN)
	db		2eh, 00h		;UART_RX_OUTPUT_REG (DCB03OU)
;       Instance name UART, Block Name TX(DCB02)
	db		28h, 1dh		;UART_TX_FUNC_REG   (DCB02FN)
	db		29h, 05h		;UART_TX_INPUT_REG  (DCB02IN)
	db		2ah, 26h		;UART_TX_OUTPUT_REG (DCB02OU)
;  Global Register values Bank 1
	...
	db		e1h, 09h		; OscillatorControl_1 register (OSC_CR1)
...
LoadConfigTBL_serialtest1_Ordered:
