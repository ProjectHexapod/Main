...
;       Instance name DAC6, Block Name DAC(ASD11)
	mov	reg[84h], 80h		;DAC6_CR0(ASD11CR0)
	mov	reg[85h], 80h		;DAC6_CR1(ASD11CR1)
	mov	reg[86h], a0h		;DAC6_CR2(ASD11CR2)
	mov	reg[87h], 30h		;DAC6_CR3(ASD11CR3)
...
;  Global Register values Bank 1
	...
	mov	reg[62h], 20h		; AnalogIOControl_0 register (ABF_CR0)
