...
export LoadConfig_serialtest1
export _LoadConfig_serialtest1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_serialtest1
	lcall	LoadConfigTBL_serialtest1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration serialtest1
;
;    Load configuration registers for serialtest1.
...
;               CUR_PP
;
_LoadConfig_serialtest1:
 LoadConfig_serialtest1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_serialtest1_Bank0
    mov     X, <LoadConfigTBL_serialtest1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_serialtest1_Bank1
    mov     X, <LoadConfigTBL_serialtest1_Bank1
